...
function loadSelftestRunners() {
  ...
  const order = [
    ...
    'ghw_controlled_write.test.js',
    'ghw_workspace_run_visibility.test.js',
    'fgr_figma_read_client.test.js',
    'fgr_connection_context_run_chat.test.js',
    'fgw_controlled_write.test.js',
    'fgval_scoring_policy.test.js',
    'fgval_structure_diff.test.js',
    'fgval_before_after_api_ui.test.js',
    'opsx_external_audit_minimum.test.js',
    'opsx_vps_external_ops_checklist.test.js',
    'pset_project_shared_env_model.test.js',
    'pset_project_settings_api.test.js',
    'ctx_project_shared_environment_context.test.js',
    'man2_projects_drive_rules.test.js',
    'man2_project_bindings.test.js',
    'thr_thread_message_conversation.test.js',
    'thr_thread_list_resume.test.js',
    'chat_workspace_first_message.test.js',
    'chat_thread_chat_api.test.js',
    'chatx_external_read_plan.test.js',
    'chatx_confirm_execution.test.js',
    'chat_min_roundtrip.test.js',
    'run_tracking_links.test.js',
